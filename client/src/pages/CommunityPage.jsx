...
function PlaceholderTab({ title, desc, icon: Icon }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "50vh", gap: "20px", padding: "48px" }}>
      <div style={{ width: 80, height: 80, borderRadius: "20px", background: "#fef3dc", display: "flex", alignItems: "center", justifyContent: "center" }}><Icon/></div>
      <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", color: "#1f1209", margin: 0 }}>{title}</h2>
      <p style={{ color: "#8b6a3e", fontSize: "1rem", margin: 0, maxWidth: 400, textAlign: "center" }}>{desc}</p>
      <span style={{ background: "#fef3dc", color: "#c8861a", padding: "6px 16px", borderRadius: "20px", fontSize: "0.8rem", fontWeight: 700 }}>Coming Soon</span>
    </div>
  );
}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "28px", paddingBottom: "64px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(290px, 1fr))", gap: "20px" }}>
        ...
        <div style={{ background: "#fff", borderRadius: "16px", padding: "24px", border: "1px solid #f0e6d2", boxShadow: "0 2px 8px rgba(160,110,40,0.04)" }}>
          ...
          {[
            { name: "Riya Sharma", dept: "CSE • Semester 7", pts: "2,450", color: "#c8861a" },
            { name: "Rahul Verma", dept: "IT • Semester 5", pts: "2,140", color: "#94a3b8" },
            { name: "Aman Verma", dept: "CSE • Semester 5", pts: "1,820", color: "#cd7f32" },
          ].map((u, i) => (
        ...
        <div style={{ background: "#fff", borderRadius: "16px", padding: "24px", border: "1px solid #f0e6d2", boxShadow: "0 2px 8px rgba(160,110,40,0.04)" }}>
          ...
          {[
            { q: "How to prepare for DBMS end semester?", by: "Priyanshu", ago: "2h", answers: 12, tag: "DBMS", tagColor: "#7c3aed", tagBg: "#EDE9FE" },
            { q: "What are the important topics in OS Unit 3?", by: "Mehak", ago: "4h", answers: 8, tag: "OS", tagColor: "#059669", tagBg: "#D1FAE5" },
            { q: "Need help in understanding CNN architecture.", by: "Arjun", ago: "6h", answers: 5, tag: "AI/ML", tagColor: "#dc2626", tagBg: "#FEE2E2" },
          ].map((d, i) => (
            <div key={i} style={{ paddingBottom: i < 2 ? "14px" : 0, marginBottom: i < 2 ? "14px" : 0, borderBottom: i < 2 ? "1px solid #f5efeb" : "none" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <span style={{ fontSize: "0.72rem", color: "#8b5e0a" }}>Asked by <b>{d.by}</b> • {d.ago} ago</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ background: "#fff", borderRadius: "16px", padding: "24px", border: "1px solid #f0e6d2", boxShadow: "0 2px 8px rgba(160,110,40,0.04)", flex: 1 }}>
            ...
            {[
              { month: "MAY", day: "25", title: "HackVerse 2024", desc: "Hackathon • Main Auditorium", interested: 120, color: "#c8861a" },
              { month: "MAY", day: "28", title: "AI & ML Workshop", desc: "Workshop • Lab 3, Block C", interested: 85, color: "#7c3aed" },
              { month: "JUN", day: "02", title: "Tech Talk: Future of Dev", desc: "Seminar • Seminar Hall", interested: 60, color: "#059669" },
            ].map((ev, i) => (
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#f8f4ee" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", width: "100%", padding: "28px 24px", flex: 1, boxSizing: "border-box" }}>
        ...
        {activeTab === "queries"     && <PlaceholderTab title="Queries" desc="Ask questions and get answers from fellow students and admins." icon={QueriesIcon} />}
        {activeTab === "archive"     && <PlaceholderTab title="Archive" desc="Browse all indexed resources, organized by course and category." icon={ArchiveIcon} />}
        {activeTab === "happening"   && <PlaceholderTab title="Happening" desc="Hackathons, webinars, workshops — never miss a campus event again." icon={HappeningIcon} />}
